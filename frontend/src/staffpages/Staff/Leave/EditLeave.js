...
function EditLeave() {
    ...
    const [maxDate, setMaxDate] = useState(null) /*  input variable  assign   */
  ...
  useEffect(() => {
    ...
    return (
      <AdminLayout>
      <div className="edit-leave-container-main" style={{ height: '900px' ,marginBottom: '30px' }}>
          {/* this is the form container */}
          <form className="edit-leave-form-container" onSubmit={handleSubmit}>
              <span className="tagline-edit-leave">EDIT LEAVE DETAILS<hr></hr></span>
              ...
              <div className="column-container">
                ...
                <div className="edit-leave-column">
                  ...
                  <section className="input-container">
                  <span className="input-title">Leave Reqested...</span><br></br>
