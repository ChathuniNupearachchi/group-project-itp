...
import menu from "../../data/usermanagerSidebar";
      ...
      <div className="sidebar" style={{ width: isOpen ? "330px" : "80px" }}>
        <div className="top_section">
          <div className="logo" style={{ display: isOpen ? "block" : "none" }}>
            <GiTronArrow
              size={26}
              style={{ cursor: "pointer" , marginLeft: "3px" , marginTop: "1px" ,color: "#CCAF31"  }}
              onClick={goHome}
            />
          ...
          <div
            className="bars"
            style={{ marginLeft: isOpen ? "34px" : "0px", marginTop: "13px"  ,color: "white"}}
          >
