...
import {Form, Row,Col,Image,ListGroup,Card,Button, ListGroupItem, FormGroup, FormLabel, FormControl} from 'react-bootstrap';
                ...
                <ListGroup variant='flush'>
                    ...
                    <ListGroup.Item>
                        <Row>
                            <Col>Status:</Col>
                            <Col>
                            <strong>{product.countInstoke > 0 ? 'In Stock' : 'Out Of Stoke'}</strong>
                            </Col> 
                        </Row>
                    </ListGroup.Item>  
                    ...
                    <ListGroup.Item>
                        <Button 
                                className='btn-block' 
                                type='Button' 
                                disabled = {product.countInstoke === 0}
