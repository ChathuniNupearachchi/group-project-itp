...
function AssignToOrder() {
	...
	useEffect(()=>{
    if(id){
      userRequest.get(`/orders/${id}`).then((response)=>{
...
//  },[id, setDelivery])
	...
	const updateOrderFormHandler = (event) => {
		...
		if (delivery._id !== "") {
			...
			userRequest.put(`/orders/${id}`, delivery).then((response) => {
				console.log(response.data);
				console.log("success");
			});
			swal.fire({
			...
			console.log(delivery);
			userRequest.put("/orders", delivery).then((response) => {
				console.log(response.data);
				console.log("success");
			});
			swal.fire({
    ...
    return (
		<AdminLayout>
            ...
            <section className="input-container">
						...
						<section className="input-container">
    					<span className="input-title">Dispatch Date:</span>
    					<input
        				className="input-field"
						...
						<section className="input-container">
    					<span className="input-title">Delivered Date:</span>
    						<input
        					className="input-field"
        					type="date"  // Set the input type to "date"
